<template>
    <AppLayout title="Crear Profesor">
        <template #header>
            ...
            <div class="card w-xs bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <div class="flex flex-col items-center">
                        <!-- DATOS GENERALES -->
                        <div>                
                            <form class="form-control w-full max-w-xs text-sm" @submit.prevent="form.post(route('admin.profesores.store'))">
...
const title = ref('Crear Profesor');
