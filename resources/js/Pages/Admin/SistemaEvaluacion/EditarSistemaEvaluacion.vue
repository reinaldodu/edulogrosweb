    ...
    <AppLayout title="Sistema evaluación">
        ...
        <div class="bg-blue-100 m-10 flex flex-col items-center rounded-md shadow-md p-2">
            <div class="card w-xs bg-base-100 shadow-xl">
                <div class="card-body">
                    <h2 class="card-title">Editar evaluación</h2>        
                    
                    <div class="flex flex-col items-center">
                        <!-- DATOS GENERALES -->
                        <div>                
                            <form class="form-control w-full max-w-xs text-sm" @submit.prevent="form.put(route('admin.sistema-evaluacion.update', form.id))">
...
const form = useForm({
    ...
    grado_id: props.evaluacion.grado_id,
    tipo_evaluacion_id: props.evaluacion.tipo_evaluacion_id,
    porcentaje: props.evaluacion.porcentaje,
    evalua_actividades: props.evaluacion.evalua_actividades ? true : false,
});
