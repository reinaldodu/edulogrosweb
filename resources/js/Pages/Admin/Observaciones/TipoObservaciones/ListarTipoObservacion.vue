<template>
    <AppLayout title="Tipos de observaciones">
        <template #header>
                            ...
                            <tr v-for="(tipo,i) in  tipos" :key="i">                            
                                ...
                                <td >
                                    <div class="tooltip tooltip-left" :data-tip="'Editar ' + tipo.nombre">
                                        <Link class="btn btn-square btn-ghost btn-xs" :href="route('admin.tipo-observaciones.edit', tipo.id)">
                                    ...
                                    <div v-if="tipo.observaciones.length==0" class="tooltip tooltip-left" :data-tip="'Eliminar ' + tipo.nombre">
                                        <label class="btn btn-ghost btn-xs modal-button" for="modal-elimina" @click="info_tipo.nombre=tipo.nombre; info_tipo.id=tipo.id">
    ...
    <div class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
            <h3 class="font-bold text-lg">Eliminar tipo observación</h3>
            <p class="py-4">¿Desea eliminar el tipo de observación {{ info_tipo.nombre }}?</p>
...
const title = ref('Lista de tipos de observaciones');
...
{
        Inertia.delete(route('admin.tipo-observaciones.destroy', id), { preserveScroll: true });
}
