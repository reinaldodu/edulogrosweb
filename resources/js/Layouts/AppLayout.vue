...
const ocultaMenu = sessionStorage.getItem('ocultaMenu') == 'true' ? ref(true) : ref(false);

//Mostrar u ocultar el menu
const cambiaMenu = () => {
    ocultaMenu.value = !ocultaMenu.value;
    sessionStorage.setItem('ocultaMenu', ocultaMenu.value);
}
            ...
            <div class="min-h-screen w-full bg-gray-100">
                <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between h-16">
                            <div class="flex">
                                <!-- Botón menu -->
                                <div class="tooltip tooltip-bottom" :data-tip="[ocultaMenu ? 'Mostrar menú' : 'Ocultar menú']">
                                    <div class="flex-none mt-2 mr-2">
                                        <button class="btn btn-ghost btn-circle" @click="cambiaMenu">
                ...
                <main>
                    ...
                    <transition leave-active-class="transition ease-in duration-1000" leave-from-class="opacity-100" leave-to-class="opacity-0">
                        <div v-if="$page.props.flash.message" class="alert alert-info shadow-lg">
                            <Messages />
                        </div>
                    </transition>
                    <slot />
